...
sourcesIndex["naga"] = {"name":"","dirs":[{"name":"back","dirs":[{"name":"spv","files":["helpers.rs","layout.rs","mod.rs","writer.rs"]}],"files":["mod.rs","msl.rs"]},{"name":"front","files":["mod.rs","spv.rs","wgsl.rs"]},{"name":"proc","files":["interface.rs","mod.rs","typifier.rs"]}],"files":["arena.rs","lib.rs"]};
...
sourcesIndex["wgpu"] = {"name":"","dirs":[{"name":"backend","files":["direct.rs","mod.rs","native_gpu_future.rs"]},{"name":"util","files":["mod.rs"]}],"files":["lib.rs","macros.rs"]};
sourcesIndex["wgpu_core"] = {"name":"","dirs":[{"name":"command","files":["allocator.rs","bind.rs","bundle.rs","compute.rs","mod.rs","render.rs","transfer.rs"]},{"name":"device","files":["life.rs","mod.rs","queue.rs","trace.rs"]},{"name":"track","files":["buffer.rs","mod.rs","range.rs","texture.rs"]}],"files":["binding_model.rs","conv.rs","hub.rs","id.rs","instance.rs","lib.rs","pipeline.rs","power.rs","resource.rs","swap_chain.rs","validation.rs"]};
